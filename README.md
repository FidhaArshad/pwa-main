...
- Sealed letter opening with an `PA` seal
- Modern non-religious reception hero background
...
- Embedded Google Map with travel guidance
- WhatsApp share button
- Browser-generated romantic music

The hero background used by the site is `assets/reception-hero.png`.
